...
RedRockIsle_MapEvents:
	...
	def_object_events
	object_event 16,  3, SPRITE_SWIMMER_GUY, SPRITEMOVEDATA_SPINCLOCKWISE, 0, 0, -1, 1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 3, RedRockIsleRock, -1
	object_event 10, 20, SPRITE_SAILOR, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, 1, 0, OBJECTTYPE_TRAINER, 4, RedRockIsleRock, -1
	object_event 13, 25, SPRITE_SUPER_NERD, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, 1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 5, RedRockIsleRock, -1
