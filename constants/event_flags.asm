...
; SwimmerM
	...
	const EVENT_BEAT_SWIMMERM_EDWIN
; Youngster
...
; Custom event flags here
	...
	const EVENT_RED_ROCK_ISLE_HIDDEN_LEAF_STONE
	const EVENT_RED_ROCK_ISLE_HIDDEN_NUGGET
	const EVENT_RED_ROCK_OUTLOOK_HIDDEN_FIRE_STONE
	const EVENT_ROUTE_41_HIDDEN_MAX_REPEL
	const EVENT_RED_ROCK_LAB_BREEDING_WATER
