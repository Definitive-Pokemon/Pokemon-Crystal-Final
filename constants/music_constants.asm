...
; new to Crystal
	...
	const MUSIC_CHERRYGROVE_CITY_NIGHT ;76
	const MUSIC_VIOLET_CITY_NIGHT ;77
	const MUSIC_AZALEA_TOWN_NIGHT ;78
	const MUSIC_GOLDENROD_CITY_NIGHT ;79
	const MUSIC_ECRUTEAK_CITY_NIGHT ;7A
	const MUSIC_PALLET_TOWN_NIGHT ;7B
	const MUSIC_VIRIDIAN_CITY_NIGHT ;7C
	const MUSIC_CERULEAN_CITY_NIGHT ;7D
	const MUSIC_VERMILION_CITY_NIGHT ;7E
	const MUSIC_CELADON_CITY_NIGHT ;7F
	const MUSIC_LAVENDER_TOWN_NIGHT ;80
	const MUSIC_ROUTE_1_NIGHT ;81
	const MUSIC_ROUTE_3_NIGHT ;82
	const MUSIC_ROUTE_12_NIGHT ;83
	const MUSIC_ROUTE_24_NIGHT ;84
	const MUSIC_ROUTE_26_NIGHT ;85
	const MUSIC_ROUTE_29_NIGHT ;86
	const MUSIC_ROUTE_30_NIGHT ;87
	const MUSIC_ROUTE_36_NIGHT ;88
