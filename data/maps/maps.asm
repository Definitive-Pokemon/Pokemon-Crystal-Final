...
MapGroup_Cianwood:
	map Route40, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_40, MUSIC_ROUTE_37, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route41, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_41, MUSIC_ROUTE_37, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
...
MapGroup_RedRock:
	map RedRockIsle, TILESET_JOHTO, ROUTE, LANDMARK_RED_ROCK_ISLE, MUSIC_ROUTE_37, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map ScarletCity, TILESET_JOHTO, TOWN, LANDMARK_SCARLET_CITY, MUSIC_ALTO_MARE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map RedRockOutlook, TILESET_JOHTO, ROUTE, LANDMARK_RED_ROCK_OUTLOOK, MUSIC_ROUTE_37, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map ScarletMart, TILESET_MART, INDOOR, LANDMARK_SCARLET_CITY, MUSIC_POKEMON_MART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ScarletPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_SCARLET_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route40BattleTowerGate, TILESET_GATE, GATE, LANDMARK_BATTLE_TOWER, MUSIC_ALTO_MARE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map WhirlCupColosseum, TILESET_PORT, INDOOR, LANDMARK_SCARLET_CITY, MUSIC_VIRBANK_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map ScarletHouse1, TILESET_HOUSE, INDOOR, LANDMARK_SCARLET_CITY, MUSIC_ALTO_MARE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ScarletHouse2, TILESET_HOUSE, INDOOR, LANDMARK_SCARLET_CITY, MUSIC_ALTO_MARE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ScarletOldHouse, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_SCARLET_CITY, MUSIC_CIANWOOD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map RedRockLab, TILESET_FACILITY, INDOOR, LANDMARK_SCARLET_CITY, MUSIC_MARINE_TUBE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SearingCrater1F, TILESET_CAVE, CAVE, LANDMARK_SEARING_CRATER, MUSIC_UNION_CAVE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SearingCraterB1F, TILESET_DARK_CAVE, CAVE, LANDMARK_SEARING_CRATER, MUSIC_UNION_CAVE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map RedRockLabBreeding, TILESET_CAVE, INDOOR, LANDMARK_SCARLET_CITY, MUSIC_MARINE_TUBE, FALSE, PALETTE_NITE, FISHGROUP_SHORE
