...
MapGroup_RedRock:
	...
	map ScarletCity, TILESET_JOHTO, TOWN, LANDMARK_SCARLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map WhirlCupColosseum, TILESET_PORT, INDOOR, LANDMARK_SCARLET_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map ScarletHouse1, TILESET_HOUSE, INDOOR, LANDMARK_SCARLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ScarletHouse2, TILESET_HOUSE, INDOOR, LANDMARK_SCARLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ScarletOldHouse, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_SCARLET_CITY, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map RedRockLab, TILESET_FACILITY, INDOOR, LANDMARK_SCARLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SearingCrater1F, TILESET_CAVE, CAVE, LANDMARK_RED_ROCK_OUTLOOK, MUSIC_UNION_CAVE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SearingCraterB1F, TILESET_DARK_CAVE, CAVE, LANDMARK_RED_ROCK_OUTLOOK, MUSIC_UNION_CAVE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
