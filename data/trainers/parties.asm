...
WhitneyGroup:
	...
	db 17, CLEFAIRY,   DOUBLESLAP, MIMIC, ENCORE, METRONOME
	db 19, MILTANK,    ROLLOUT, ATTRACT, STOMP, MILK_DRINK
	db -1 ; end
...
WillGroup:
	...
	; WILL (2)
	db "WILL@", TRAINERTYPE_MOVES
	db 60, WOBBUFFET,       COUNTER, MIRROR_COAT, DESTINY_BOND, SAFEGUARD
	db 62, JYNX,       PSYCHIC_M, LOVELY_KISS, DREAM_EATER, BLIZZARD
	db 61, EXEGGUTOR,  REFLECT, LEECH_SEED, GIGA_DRAIN, PSYCHIC_M
	db 62, SLOWBRO,    CURSE, AMNESIA, BODY_SLAM, PSYCHIC_M
	db 64, XATU,       QUICK_ATTACK, DRILL_PECK, CONFUSE_RAY, PSYCHIC_M
	db -1 ; end
...
BrunoGroup:
	...
	; BRUNO (2)
	db "BRUNO@", TRAINERTYPE_MOVES
	db 64, HITMONTOP,  DOUBLE_TEAM, EARTHQUAKE, COUNTER, QUICK_ATTACK
	db 63, HITMONLEE,  MEGA_KICK, HI_JUMP_KICK, REVERSAL, SWAGGER
	db 63, HITMONCHAN, MEGA_PUNCH, DYNAMICPUNCH, AGILITY, SUBSTITUTE
	db 66, HERACROSS,       HEADBUTT, EARTHQUAKE, MEGAHORN, SEISMIC_TOSS
	db 68, MACHAMP,    DYNAMICPUNCH, ROCK_SLIDE, CROSS_CHOP, FORESIGHT
	db -1 ; end
...
KarenGroup:
	...
	; KAREN (2)
	db "KAREN@", TRAINERTYPE_MOVES
	db 66, SNEASEL,    DYNAMICPUNCH, SHADOW_BALL, DIG, REFLECT
	db 64, VILEPLUME,  SLEEP_POWDER, SLUDGE_BOMB, MOONLIGHT, LEECH_SEED
	db 64, GENGAR,     THUNDERBOLT, ICE_PUNCH, HYPNOSIS, DREAM_EATER
	db 68, HOUNDOOM,   PURSUIT, CRUNCH, FLAMETHROWER, SLUDGE_BOMB
	db 70, UMBREON,    CHARM, TOXIC, PURSUIT, MOONLIGHT
	db -1 ; end
...
KogaGroup:
	...
	; KOGA (2)
	db "KOGA@", TRAINERTYPE_MOVES
	db 63, ARIADOS,    DOUBLE_TEAM, SPIDER_WEB, BATON_PASS, GIGA_DRAIN
	db 65, VENOMOTH,   BATON_PASS, DOUBLE_TEAM, PSYCHIC_M, SLEEP_POWDER
	db 62, TENTACRUEL, SURF, SLUDGE_BOMB, ICE_BEAM, SUPERSONIC
	db 64, MUK,        MINIMIZE, SCREECH, SWAGGER, TOXIC
	db 66, CROBAT,     FLY, CONFUSE_RAY, MEAN_LOOK, TOXIC
	db -1 ; end
...
ChampionGroup:
	...
	; CHAMPION (2)
	db "LANCE@", TRAINERTYPE_MOVES
	db 72, LAPRAS,   ICE_BEAM, THUNDERBOLT, SURF, IRON_TAIL
	db 68, MEGANIUM,  RAZOR_LEAF, LIGHT_SCREEN, EARTHQUAKE, SYNTHESIS
	db 72, TYRANITAR,  ROCK_SLIDE, CRUNCH, FIRE_BLAST, EARTHQUAKE
	db 73, KANGASKHAN, BODY_SLAM, SUBSTITUTE, EARTHQUAKE, ROCK_SLIDE
	db 68, CHARIZARD,  FLAMETHROWER, HYPER_BEAM, EARTHQUAKE, FLY
...
ErikaGroup:
	...
	db 51, TANGELA,    VINE_WHIP, BIND, GIGA_DRAIN, SLEEP_POWDER
...
BlueGroup:
	...
	db 52, GYARADOS,   TWISTER, HYDRO_PUMP, RAIN_DANCE, HYPER_BEAM
	db 55, EXEGGUTOR,  SUNNY_DAY, LEECH_SEED, EGG_BOMB, SOLARBEAM
