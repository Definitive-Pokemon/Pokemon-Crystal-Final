...
; entries correspond to SPRITE_* constants
	...
	overworld_sprite WhayneSpriteGFX, 12, WALKING_SPRITE, PAL_OW_BLUE
	overworld_sprite DioSpriteGFX, 12, WALKING_SPRITE, PAL_OW_RED
	overworld_sprite FauneSpriteGFX, 12, WALKING_SPRITE, PAL_OW_GREEN
