...
AbraIcon          INCBIN "gfx/icons/abra.2bpp"abra.2bpp"
...
Mr_MimeIcon          INCBIN "gfx/icons/mr_mime.2bpp"
...
Snorlax          INCBIN "gfx/icons/snorlax.2bpp"
...
Ho-ohIcon          INCBIN "gfx/icons/ho-oh.2bpp"
